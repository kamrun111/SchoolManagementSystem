...
namespace SchoolManagementSystem.Reports {
    ...
    public class ReceivedPayment : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "SchoolManagementSystem.Reports.ReceivedPayment.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReceivedPayment : Component, ICachedReport {
        
        public CachedReceivedPayment() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ReceivedPayment rpt = new ReceivedPayment();
            rpt.Site = this.Site;
            return rpt;
        }
